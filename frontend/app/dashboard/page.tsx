...
export default function Dashboard() {
  ...
  if (isDeveloperRole(user?.role)) {
    return <DeveloperDashboard summary={summary} error={error} />;
  }
...
function DeveloperDashboard({
    ...
    () => [
      {
        ...
        meta: "Tasks currently assigned to you",
      },
      {
        label: "Completed",
        value: summary ? `${summary.metrics.completedTasks}` : "--",
        meta: "Tasks approved in your training workflow",
      },
      {
        label: "External feedback",
        value: summary ? `${summary.metrics.feedbackCount}` : "--",
        meta: "Visible coaching and review notes",
      },
    ],
    [summary]
  );
  ...
  const quickActions = [
    {
      title: "My Tasks",
      description: "Track your assignments, due dates, uploads, and task status updates.",
    ...
    {
      title: "My Profile",
      description: "Open your profile, update allowed fields, and review training progress.",
      icon: <FaIdBadge />,
            ...
            <div className="space-y-5">
              ...
              <div className="page-header-main">
                ...
                <p className="page-header-copy max-w-2xl text-base">
                  Stay on top of your tasks, profile, training progress, and external feedback from the existing workspace dashboard.
                </p>
              </div>
        ...
        <section className="space-y-4">
          <div className="flex items-end justify-between gap-4">
            <div>
              ...
              <h2 className="font-display mt-2 text-3xl font-bold text-slate-950">Navigate your core workflows</h2>
            </div>
          </div>
          ...
          <section className="grid gap-4 lg:grid-cols-2">
            <div className="premium-panel rounded-[26px] p-6">
              <div className="section-topline">
                <div>
                  <p className="text-sm font-semibold uppercase tracking-[0.14em] text-slate-400">My tasks</p>
                  <p className="section-subtitle mt-2">Recent assignments and status updates in your queue.</p>
                </div>
                ...
                {summary.recentTasks.length === 0 ? (
                  ...
                  summary.recentTasks.map((task) => (
                    <div key={task.id} className="list-card">
                      ...
                      <p className="mt-1 text-sm text-slate-500">{task.status.replaceAll("_", " ")}</p>
                    </div>
                  ))
                )}
              </div>
            ...
            <div className="premium-panel rounded-[26px] p-6">
              <div className="section-topline">
                <div>
                  <p className="text-sm font-semibold uppercase tracking-[0.14em] text-slate-400">External feedback</p>
                  <p className="section-subtitle mt-2">Latest visible feedback attached to your training journey.</p>
                </div>
                <div className="soft-stat hidden md:block">
